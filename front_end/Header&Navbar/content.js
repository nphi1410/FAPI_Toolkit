...
<div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
    <a href="https://fap.fpt.edu.vn/Student.aspx" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="https://i.ibb.co/dLMy0d8/logo.png" class="h-8" alt="FAP Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FAP</span>
    </a>
  ...
  <label id="darkmode-toggle" class="relative inline-flex items-center cursor-pointer">
    <div class="absolute z-10 flex items-center justify-between w-full px-1 text-lg">
      <i class="fas fa-moon"></i>
      <i class="fas fa-sun"></i>
    </div>
    <input id="darkmode-checkbox" type="checkbox" value="" class="sr-only peer" checked disabled>
    <div class="relative w-16 h-8 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:z-20 after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-7 after:w-7 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
  </label>
